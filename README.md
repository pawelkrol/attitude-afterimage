...
Version 0.09-SNAPSHOT (2021-02-21)
...
You can automatically download and install this library by adding the following dependency information to your `build.sbt` configuration file:
    ...
    libraryDependencies += "org.c64.attitude" % "afterimage" % "0.09-SNAPSHOT"
...
Assuming an above script has been saved into a `convert.scala` file, it can be executed using the following command(s):
    ...
    $ export AFTERIMAGE=/home/pkrol/.ivy2/cache/org.c64.attitude/afterimage/jars/afterimage-0.09-SNAPSHOT.jar
    $ export IMAGEJ=/home/pkrol/.ivy2/cache/gov.nih.imagej/imagej/jars/imagej-1.47.jar
    $ export JSON_4S=/home/pkrol/.ivy2/cache/org.json4s/json4s-ast_2.13/jars/json4s-ast_2.13-3.6.10.jar:/home/pkrol/.ivy2/cache/org.json4s/json4s-core_2.32/jars/json4s-core_2.13-3.6.10.jar:/home/pkrol/.ivy2/cache/org.json4s/json4s-native_2.13/jars/json4s-native_2.13-3.6.10.jar
